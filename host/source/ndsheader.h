#ifndef _NDSHEADER_H_
#define _NDSHEADER_H_
...
struct ndsHeader {
	...
	unsigned char global_mbk_setting[5][4];
	...
	unsigned char offset_0x1BC[3];
	unsigned char appflags;
	...
	unsigned char reserved3[176];
	unsigned char age_ratings[0x10];

	unsigned char hmac_arm9[20];
	unsigned char hmac_arm7[20];
	unsigned char hmac_digest_master[20];
	unsigned char hmac_icon_title[20];
	unsigned char hmac_arm9i[20];
	unsigned char hmac_arm7i[20];
	unsigned char reserved4[40];
	unsigned char hmac_arm9_no_secure[20];
